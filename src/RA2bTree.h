...
// Tue Feb 25 03:04:33 2020 by ROOT version 6.06/09
// from TTree PreSelection/PreSelection
// found on file: /eos/uscms//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV18b/Summer16v3.TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_0_RA2AnalysisTree.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *JetsAK8_deepDoubleBDiscriminatorH; //remove for V18
   ...
   vector<double>  *JetsAK8_pfMassIndependentDeepDoubleCvBJetTagsProbHcc;
   vector<double>  *JetsAK8_pfMassIndependentDeepDoubleCvLJetTagsProbHcc;
   ...
   TBranch        *b_JetsAK8_deepDoubleBDiscriminatorH;   //! //remove for V18
   ...
   TBranch        *b_JetsAK8_pfMassIndependentDeepDoubleCvBJetTagsProbHcc;   //!
   TBranch        *b_JetsAK8_pfMassIndependentDeepDoubleCvLJetTagsProbHcc;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV18b/Summer16v3.TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_0_RA2AnalysisTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV18b/Summer16v3.TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_0_RA2AnalysisTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/uscms//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV18b/Summer16v3.TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_0_RA2AnalysisTree.root:/TreeMaker2");
...
void RA2bTree::Init(TChain *tree)
{
   ...
   JetsAK8_deepDoubleBDiscriminatorH = 0; //remove for V18
   JetsAK8_ecfN2b1 = 0;
   JetsAK8_ecfN2b2 = 0;
   JetsAK8_ecfN3b1 = 0;
   JetsAK8_ecfN3b2 = 0;
   ...
   JetsAK8_pfMassIndependentDeepDoubleCvBJetTagsProbHcc = 0;
   JetsAK8_pfMassIndependentDeepDoubleCvLJetTagsProbHcc = 0;
   ...
   fChain->SetBranchAddress("JetsAK8_deepDoubleBDiscriminatorH", &JetsAK8_deepDoubleBDiscriminatorH, &b_JetsAK8_deepDoubleBDiscriminatorH); //remove for V18
   ...
   fChain->SetBranchAddress("JetsAK8_pfMassIndependentDeepDoubleCvBJetTagsProbHcc", &JetsAK8_pfMassIndependentDeepDoubleCvBJetTagsProbHcc, &b_JetsAK8_pfMassIndependentDeepDoubleCvBJetTagsProbHcc);
   fChain->SetBranchAddress("JetsAK8_pfMassIndependentDeepDoubleCvLJetTagsProbHcc", &JetsAK8_pfMassIndependentDeepDoubleCvLJetTagsProbHcc, &b_JetsAK8_pfMassIndependentDeepDoubleCvLJetTagsProbHcc);

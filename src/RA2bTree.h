...
RA2bTree::RA2bTree(TChain *tree) : fChain(0)
{
  ...
  if (tree == 0) {
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uscms_data/d2/rgp230/T5ZZ/SignalSkimCode/CMSSW_8_0_30/src/Analysis/tree_signal/tree_TChiHH_HToBB_HToBB_700_1_MC2016_fast.root");
    if (!f || !f->IsOpen()) {
      f = new TFile("/uscms_data/d2/rgp230/T5ZZ/SignalSkimCode/CMSSW_8_0_30/src/Analysis/tree_signal/tree_TChiHH_HToBB_HToBB_700_1_MC2016_fast.root");
    }
